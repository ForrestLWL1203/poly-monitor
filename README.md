...
quotes before submitting new ones: improved bids are chased with
`quote_improved_replace`, missing quotes cancel as `quote_unavailable`,
balanced inventory cancels as `balance_reconciled`, and surplus side quotes
cancel as `side_no_longer_needed`.
