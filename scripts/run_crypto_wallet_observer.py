...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--cleanup-interval-hours", type=float, default=1.0)
    ...
    parser.add_argument("--max-dormant-candidates", type=int, default=0)
    ...
    parser.add_argument("--watchlist-activity-retention-days", type=int, default=2)
    parser.add_argument("--non-watchlist-activity-retention-days", type=int, default=2)
    parser.add_argument("--context-retention-days", type=int, default=2)
    parser.add_argument("--research-cleanup-dormant-wallets", type=int, default=0)
    parser.add_argument("--market-state-retention-days", type=int, default=2)
    parser.add_argument("--strategy-archive-interval-hours", type=float, default=1.0)
